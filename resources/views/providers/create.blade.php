...
@endphp
@section('title')Add a new {{str_replace('s','',$provider)}} @endsection
@section('location-nav')
    <ol class="breadcrumb panel">
        <li><a href="{{url('/')}}">Dashboard</a></li>
        <li><a href="{{url('providers/'.$type)}}">{{$provider}} management </a></li>
        <li class="active"><strong>Add a new {{str_replace('s','',$provider)}}</strong></li>
    </ol>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            @endif
            <form class="form-horizontal" method="post" action="{{url('providers/'.$type)}}">
                ...
                <div class="form-group ">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('web_site')) has-error @endif">
                        <input type="text" value="{{old('web_site')}}" name="web_site" class="form-control">
