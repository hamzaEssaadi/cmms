...
@section('title')Add Work exception to {{$employee->name}} @endsection
@section('location-nav')
    <ol class="breadcrumb panel">
        ...
        <li class="active"><strong>Add a new Work exception</strong></li>
    </ol>
@endsection
@section('css')
...
@section('content')
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            @endif
            <form method="post" action="{{url('exceptions/'.$employee->id)}}">
                <div class="form-group @if($errors->has('exception')) has-error @endif">
                    <label for="exception">Exception :</label>
                    <input id="exception" type="text" class="form-control" value="{{old('exception')}}" name="exception" required=""/>
                ...
                <div class="form-group @if($errors->has('begin_date')) has-error @endif">
                    ...
                    <input id="begin_date" type="text" class="form-control" value="{{old('begin_date')}}"
