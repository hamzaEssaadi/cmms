...
@section('title')Add a new Employee @endsection
@section('location-nav')
    <ol class="breadcrumb panel">
        <li><a href="{{url('/')}}">Dashboard</a></li>
        <li><a href="{{url('employees')}}">Employees management </a></li>
        <li class="active"><strong>Add a new Employee</strong></li>
    </ol>
@endsection
@section('x_title')
        ...
        <div class="row">
            <div class="col-md-6">
                ...
                <div class="form-group @if($errors->get('cin')) has-error @endif">
                    ...
                    <input id="cin" type="text" name="cin" value="{{old('cin')}}"
                           class="form-control"/>
                ...
                <div class="form-group @if($errors->get('hiring_date')) has-error @endif">
                    ...
                    <input id="hiring_date" type="text" name="hiring_date" value="{{old('hiring_date')}}"
                ...
                <div class="form-group @if($errors->get('nationality')) has-error @endif">
                    ...
                    <select class="form-control " id="nationality" name="nationality">
                        @foreach($countries as $country)
                            <option @if ($country->name=="Morocco") selected=""
                ...
                <div class="form-group @if($errors->get('image')) has-error @endif">
                    <label for="image">Image file (<2mb) :</label>
            ...
            <div class="col-md-6">
                ...
                <div class="form-group myclass @if($errors->get('zip_code')) has-error @endif">
                ...
                <div class="form-group @if($errors->get('social_security_no')) has-error @endif">
                    ...
                    <input type="text" required="" class="form-control" value="{{old('social_security_no')}}"
                ...
                <div class="form-group @if($errors->get('jobposition')) has-error @endif">
                    ...
                    @foreach($errors->get('jobposition') as $error)
                        <li style="color: red; margin-left: 12px;">{{$error}}</li>
                    @endforeach
                </div>
