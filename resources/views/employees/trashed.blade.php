...
@section('title')Deleted employees @endsection
@section('x_title')
            ...
            <tr>
                ...
                <td>
                    @can('restore',$employee)
                        <a href="#" class="" data-toggle="modal" data-target=".bs-example-modal-employee">
                            <i onclick="pass_employee('{{$employee->id}}')" title="Restore" class="fa fa-undo"></i>
                        </a>
                    @endcan
                </td>
            </tr>
        ...
        <div class="modal-dialog modal-sm">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Warning</h4>
                    <h6><strong>Are you sure to restore that employee ?!</strong></h6>
                </div>
                <form id="restore_employee_form" method="post">
...
@section('script')
    ...
    <script>
        ...
        {
            $('#restore_employee_form').attr('action','{{url('employees')}}'+'/'+id+'/restore')
        }
