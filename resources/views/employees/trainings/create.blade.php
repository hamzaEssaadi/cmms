...
@section('title')Add new Training for {{$employee->name}} @endsection
@section('location-nav')
    <ol class="breadcrumb panel">
        ...
        <li class="active"><strong>Add new Training</strong></li>
    </ol>
@endsection
@section('x_title')
...
@section('content')
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            @endif
            <form method="post" action="{{url('trainings/'.$employee->id)}}">
                <div class="form-group @if($errors->has('title')) has-error @endif">
                    <label for="title">Title :</label>
                    <input id="title" type="text" class="form-control" value="{{old('title')}}"  name="title" required=""/>
                ...
                <div class="form-group @if($errors->has('description')) has-error  @endif">
                    ...
                    <textarea class="form-control" id="description"  required="" name="description">{{old('description')}}</textarea>
                ...
                <div class="form-group @if($errors->has('date_start')) has-error @endif">
                    ...
                    <input id="date_start" type="text" class="form-control mydate" value="{{old('date_start')}}"  name="date_start" required=""/>
                ...
                <div class="form-group @if($errors->has('date_end')) has-error  @endif">
                    ...
                    <input id="date_end" type="text" class="form-control mydate" value="{{old('date_end')}}"  name="date_end" required=""/>
