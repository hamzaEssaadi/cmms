...
@section('title')Add a new Work order type @endsection
@section('location-nav')
    <ol class="breadcrumb panel">
        <li><a href="{{url('/')}}">Dashboard</a></li>
        <li><a href="{{route('work-order-types.index')}}">Work orders types</a></li>
        <li class="active"><strong>Add a new Work orders type</strong></li>
    </ol>
@endsection
...
@section('content')
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            @endif
            <form method="post" action="{{route('work-order-types.store')}}">
