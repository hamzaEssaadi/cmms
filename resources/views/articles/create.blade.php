...
@section('title')Add new Article @endsection
@section('location-nav')
    <ol class="breadcrumb panel">
        <li><a href="{{url('/')}}">Dashboard</a></li>
        <li><a href="{{url('articles')}}">Articles management </a></li>
        <li class="active"><strong>Add a new Article</strong></li>
    </ol>
@endsection
        ...
        <div class="row">
            <div class="col-md-6 col-md-offset-3">
                ...
                <div class="form-group  @if($errors->get('weight')) has-error @endif ">
                    ...
                    <input id="weight" type="number" step="0.001" class="form-control" value="{{old('weight')}}"
                           name="weight"/>
                ...
                <div class="form-group  @if($errors->get('model')) has-error @endif ">
                    ...
                    <input id="model" type="text" class="form-control" value="{{old('model')}}" name="model"
                           required=""/>
                ...
                <div class="form-group  @if($errors->get('volume')) has-error @endif ">
                    ...
                    <input id="volume" type="number" step="0.001" class="form-control" value="{{old('volume')}}"
                           name="volume"/>
                ...
                <div class="form-group  @if($errors->get('supply_point')) has-error @endif ">
                    ...
                    <input id="supply_point" type="number" min="0" class="form-control" value="{{old('supply_point')}}"
                ...
                <div class="form-group  @if($errors->get('added_in')) has-error @endif ">
                    ...
                    <input id="added_in" type="text" class="form-control mydate" value="{{old('added_in')}}" name="added_in"/>
