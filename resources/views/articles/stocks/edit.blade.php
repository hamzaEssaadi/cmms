        ...
        <div class="col-md-6 col-md-offset-3">
            ...
            <form method="post" action="{{url('stocks/'.$article->id)}}">
                <div class="form-group @if($errors->has('site')) has-error @endif">
                    ...
                    <input id="site" type="text" class="form-control" value="{{old('site')}}" name="site" required=""/>
                ...
                <div class="form-group @if($errors->has('qte')) has-error @endif">
                    ...
                    <input id="qte" type="number" min="0"  class="form-control" value="{{old('qte',1)}}" name="qte" required=""/>
