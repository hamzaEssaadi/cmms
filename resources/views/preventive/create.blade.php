...
@section('title')Add a new Intervention Preventive @endsection
@section('location-nav')
    <ol class="breadcrumb panel">
        <li><a href="{{url('/')}}">Dashboard</a></li>
        <li><a href="{{route('preventive-interventions.index')}}">Intervention Preventive management </a></li>
        <li class="active"><strong>Add a new Intervention Preventive</strong></li>
    </ol>
@endsection
...
@section('content')
    <form method="post" action="{{route('preventive-interventions.store')}}">
        <div class="row">
            <div class="col-md-6 col-md-offset-3 col-xs-12">
                ...
                <div class="form-group  @if($errors->get('intervention_start')) has-error @endif ">
                    ...
                    <input type="text" value="{{old('intervention_start')}}" class="form-control"
                ...
                <div class="form-group  @if($errors->get('intervention_end')) has-error @endif ">
                    ...
                    <input type="text" value="{{old('intervention_end')}}" class="form-control"
                           id="intervention_end"
