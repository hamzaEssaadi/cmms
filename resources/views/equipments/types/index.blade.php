...
@section('title') Equipment Types @endsection

@section('x_title')
    <h2>Equipment Type list</h2>
    <a href="{{route('equipment-types.create')}}" class="btn btn-primary pull-right">Add new Equipment Type</a>
                    ...
                    <tr>
                        ...
                        <td>
                            <a data-toggle="tooltip" data-original-title="Edit"
                               href="{{route('equipment-types.edit',['type'=>$type->id])}}"><i
