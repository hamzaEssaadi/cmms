...
@stop
@section('title') Edit an Equipment @endsection
@section('location-nav')
    <ol class="breadcrumb panel">
        <li><a href="{{url('/')}}">Dashboard</a></li>
        <li><a href="{{route('equipments.index')}}">Equipments management</a></li>
        <li class="active"><strong>Edit an Equipment</strong></li>
    </ol>
@endsection
@section('x_title')
...
@section('content')
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            @endif
            <form class="form-horizontal" method="post" action="{{route('equipments.update',['equipment'=>$equipment->id])}}">
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('code')) has-error @endif">
                        <input type="text" id="code" value="{{old('code',$equipment->code)}}" required="" name="code" class="form-control  ">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('serial_number')) has-error @endif">
                        <input type="text" value="{{old('serial_number',$equipment->serial_number)}}" required="" name="serial_number"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('model_number')) has-error @endif">
                        <input type="text" value="{{old('model_number',$equipment->model_number)}}" required="" name="model_number"
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('type')) has-error @endif">
                        <select name="type" id="type" class="form-control">
                            @foreach($types as $type)
                                <option @if($type->id==$equipment->equipment_type_id) selected="" @endif value="{{$type->id}}">{{$type->code}}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('purchase_date')) has-error @endif">
                        <input type="text" value="{{old('purchase_date',$equipment->purchase_date)}}" required="" name="purchase_date"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('warranty_expiration_date')) has-error @endif">
                        <input type="text" value="{{old('warranty_expiration_date',$equipment->warranty_expiration_date)}}" required=""
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('starting_date')) has-error @endif">
                        <input type="text" value="{{old('starting_date',$equipment->starting_date)}}" required="" name="starting_date"
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('life_time')) has-error @endif">
                        <input type="number" step="0.25" value="{{old('life_time',$equipment->life_time)}}" required="" name="life_time"
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('security_note')) has-error @endif">
                        <select name="location" id="location" class="form-control">
                            @foreach($locations as $location)
                                <option @if($location->id==$equipment->location_id) selected="" @endif value="{{$location->id}}">{{$location->code}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('department')) has-error @endif">
                        <select name="department" id="department" class="form-control">
                            @foreach($departments as $department)
                                <option @if($department->id==$equipment->department_id) selected="" @endif value="{{$department->id}}">{{$department->code}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('supplier')) has-error @endif">
                        <select name="supplier" id="supplier" class="form-control">
                            @foreach($suppliers as $supplier)
                                <option @if($supplier->id==$equipment->supplier_id) selected="" @endif value="{{$supplier->id}}">{{$supplier->code}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('manufacturer')) has-error @endif">
                        <select name="manufacturer" id="manufacturer" class="form-control">
                            @foreach($manufacturers as $manufacturer)
                                <option @if($manufacturer->id==$equipment->manufacturer_id) selected="" @endif value="{{$manufacturer->id}}">{{$manufacturer->code}}</option>
                            @endforeach
                        </select>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('employee')) has-error @endif">
                        <select name="employee" id="employee" class="form-control">
                            @foreach($employees as $employee)
                                <option @if($employee->id==$equipment->employee_id) selected="" @endif value="{{$employee->id}}">{{$employee->name}} ({{$employee->jobposition->code}})</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('cost')) has-error @endif">
                        <input type="number" step="0.01" value="{{old('cost',$equipment->cost)}}" required="" name="cost"
                               id="life_time" class="form-control">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12 @if($errors->get('security_note')) has-error @endif">
                        <textarea type="text"  required="" name="security_note"
                                  id="security_note" class="form-control">{{old('security_note',$equipment->security_note)}}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="checkbox"  @if($equipment->in_service) checked="" @endif class="js-switch" name="in_service" id="in_service"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-12">
                        <input type="text" id="contract"
                               value="{{old('contract',$equipment->contract)}}" class="form-control"
                               name="contract"/>
                    </div>
                </div>
                @method('put')
